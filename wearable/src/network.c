...
#if defined TIZEN_EXT
	/* To avoid association retry by wpa_supplicant,
	* it needs "RemoveNetwork" when connection is failed */
	if (error == CONNMAN_NETWORK_ERROR_CONNECT_FAIL ||
...
{
#if defined TIZEN_EXT
	if (g_str_equal(key, "WiFi.Passphrase") != TRUE)
#endif
