...
{
	/* It guarantees that significant_wifi_profile_refcount of connman_device instance should not be changed */
	return (connman_bool_t)g_atomic_int_compare_and_exchange(&device->significant_wifi_profile_refcount, 0, 0);
}
#endif
